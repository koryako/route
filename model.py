...
#https://github.com/NoobFang/multi-process-UNREAL/blob/master/model.py
...
class UnrealModel(object):
  ...
  def base_loss(self):
    ...
    value_loss = 0.5 * tf.nn.l2_loss(self.base_r - self.base_v)#https://blog.csdn.net/u013236946/article/details/73195035
    base_loss = policy_loss + value_loss#基础误差由决策误差和值误差
